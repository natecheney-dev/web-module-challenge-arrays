...
addFlavor(originalFlavors,"Chocolate Milk");
...
*/
const apples = ['Chocolate Apples', 'Chocolate Bananas', 'Chocolate Fruit', 'Apples', 'Random','Placeholder'];
...
function getAverageWordLength(array) {
  let wordnumber = 0;
  for (let i = 0; i < array.length; i++) {
    wordnumber = wordnumber + array[i].split(" ").length;
  }
